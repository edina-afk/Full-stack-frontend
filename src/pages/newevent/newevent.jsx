      ...
      >
        ...
        <div className="flex flex-col min-w-0">
          ...
          <input
            ...
            className="w-full min-w-0 p-2.5 rounded border border-gray-300 text-base outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
        ...
        <div className="flex flex-col min-w-0">
          ...
          <input
            ...
            className="w-full min-w-0 p-2.5 rounded border border-gray-300 text-base"
          />
        ...
        <div className="flex flex-col min-w-0">
          ...
          <input
            ...
            readOnly
            className="w-full min-w-0 p-2.5 rounded border border-gray-300 text-base bg-gray-100 cursor-not-allowed outline-none"
          />
